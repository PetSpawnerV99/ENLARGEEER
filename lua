...
applyBtn.MouseButton1Click:Connect(function()
	...
	if tool then
		...
		updatePetInfoLabel()
		print("Applied scale and updated weight: " .. tool.Name)
	else
...
resetBtn.MouseButton1Click:Connect(function()
	...
	if tool and originalData[tool] then
		...
		updatePetInfoLabel()
		print("Reset pet to original: " .. tool.Name)
	else
		warn("No original data saved or no pet equipped.")
	end
end)
